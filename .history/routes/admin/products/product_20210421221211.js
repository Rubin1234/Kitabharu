    ...
    deleteProduct.exec(async function(err,data){
        ...
        if(data.flash_sale == null && data.special_offer == null && data.bulk_offer == null ){
            ...
            deleteProductArray.exec(async function(err1,data1){   
                if(data.category_id._id == '5fc86fabe5825658544dfa06'){  //If Category is Book
                    if(data.images.length > 0){  //IF Product Image is Not Empty
                        ...
                        //IF Ebook_id Is not null or Ebook file is present
                        if(data.ebook_id != null  ){
                            var deleteEbook = ebookModel.findByIdAndDelete(data.ebook_id);
                            if(data.book_attribute.length > 0){   //Book Attribute is not empty
                                ...
                                deleteProductImages.exec(function(err3,data3){  //Book Attribute is  empty
                                    var removeProductImages = ModelProduct.update({_id:id}, { $pull: { images: { $in: data3._id  } }});  
                        ...
                        if(data.ebook_id != null  ){     //IF Product Image is  Empty  //If Ebook is not null
                        var deleteEbook = ebookModel.findByIdAndDelete(data.ebook_id);
